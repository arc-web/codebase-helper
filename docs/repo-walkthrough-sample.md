...
**Preset:** Repo Walkthrough
**Source:** `ai/agents/development/codebase_helper/smoke/fixtures/repo-walkthrough-sample.md`
**Use:** Navigable codebase tour with exact paths and commands.
